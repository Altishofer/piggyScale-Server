...
namespace Project.Hubs
{
    ...
    { 
        ...
        public async Task SendWaitRankingToGroup(string groupName)
        {
            Console.WriteLine($"SendWaitRankingToGroup -> {"hello"}");
            await _hubContext.Clients.Group(groupName).SendAsync("ReceiveWaitResult", "hello");
        }
        
        public async Task SendFullResultToGroup(string groupName, List<string> resultDto)
        {
